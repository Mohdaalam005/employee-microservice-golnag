...
var EmployeeWhere = struct {
	...
	Dob:    whereHelpernull_String{field: "\"employee\".\"dob\""},
	Gender: whereHelpernull_String{field: "\"employee\".\"gender\""},
}
...
var (
	employeeAllColumns            = []string{"id", "name", "dob", "gender"}
	employeeColumnsWithoutDefault = []string{}
	employeeColumnsWithDefault    = []string{"id", "name", "dob", "gender"}
